...
export RAG_MODE="${RAG_MODE:-dual}"
export RAG_SOURCE_ENDPOINT="${RAG_SOURCE_ENDPOINT:-/retrieve_sources}"
export RAG_PASSAGE_ENDPOINT="${RAG_PASSAGE_ENDPOINT:-/retrieve_passages}"
export RAG_ENDPOINT="${RAG_ENDPOINT:-/getReference}"
